...
import { fetchTokenData, TokenFetchData } from '@/utils/virtual/tokenData'
...
const ctHashState = typeof window !== 'undefined' && localStorage.getItem('ctHash') || null

const blockNumberState = typeof window !== 'undefined' && localStorage.getItem('blockNumber') || null
