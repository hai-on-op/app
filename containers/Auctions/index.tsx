...
const Auctions = () => {
    ...
    const queryType = (typeof router.query.type === 'string' ? router.query.type : 'SURPLUS') as AuctionEventType
    const [type, setType] = useState<AuctionEventType>(queryType)
    ...
    }, [router.query.auctionType, auctions, auctionsActions, geb, selectedItem, type])
