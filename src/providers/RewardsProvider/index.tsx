...
export function RewardsProvider({ children }: { children: React.ReactNode }) {
    ...
    const rewardsValue: RewardsContextValue = useMemo(() => {
        return {
            staking: {
                ...
                userRewards: {
                    ...
                    refetch: () =>
                        queryClient.invalidateQueries({ queryKey: ['rewards', 'staking', 'userRewards', address] }),
                },
            },
            incentives: {
                claims: {
                ...
                timer: {
                    ...
                    refetch: () =>
                        queryClient.invalidateQueries({ queryKey: ['rewards', 'incentives', 'timer', chainId] }),
                },
            },
            vaults: {
        ...
        tvlQuery.data,
        tvlQuery.isLoading,
        userRewardsQuery.data,
        userRewardsQuery.isLoading,
        incentivesClaimsQuery.data,
        incentivesClaimsQuery.isLoading,
        incentivesTimerQuery.data,
        incentivesTimerQuery.isLoading,
        address,
        chainId,
        queryClient,
    ])
