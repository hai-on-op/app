...
describe('haiBoldCurveLpConfig', () => {
    ...
    it('has expected decimals and subgraph metadata', () => {
        ...
        expect(haiBoldCurveLpConfig.subgraph.userEntity).toBe('stakingUser')
        expect(haiBoldCurveLpConfig.subgraph.statsEntity).toBe('stakingStatistic')
        expect(haiBoldCurveLpConfig.subgraph.idForUser('0xABC')).toBe('lp-hai-bold-curve-0xabc')
        expect(haiBoldCurveLpConfig.subgraph.idForStats()).toBe('lp-hai-bold-curve')
    })
})
