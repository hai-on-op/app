...
describe('StakeStats uses V2 APR', () => {
    it('renders values from useStakingSummaryV2', () => {
        ;(v2.useStakingSummaryV2 as jest.Mock).mockReturnValue({
            ...
            myStaked: { amount: 10, amountFormatted: '10', usdValue: 10, usdValueFormatted: '$10', effectiveAmount: 10, effectiveAmountFormatted: '10' },
            myShare: { value: 10, percentage: '10%' },
            stakingApr: { value: 1234, formatted: '12.34%' },
            boost: { netBoostValue: 1.0, netBoostFormatted: '1.00x', boostedValue: 0, boostedValueFormatted: '$0', haiVeloBoost: 0, lpBoost: 0, haiMintingBoost: 0, haiVeloPositionValue: 0, userLPPositionValue: 0, haiMintingPositionValue: 0 },
            stakingData: {},
            simulateNetBoost: () => 1,
            calculateSimulatedValues: () => ({ simulationMode: false, totalStakedAfterTx: 0, myStakedAfterTx: 0, myShareAfterTx: 0, netBoostAfterTx: 1 }),
        })
