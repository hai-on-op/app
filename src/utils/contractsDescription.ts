...
export const contractsDescriptions: { [k: string]: string } = {
    ...
    postSettlementSurplusAuctionHouse: 'The PostSettlementSurplusAuctionHouse contract is responsible for auctioning all remaining surplus after Global Settlement is triggered.',
    postSettlementSurplusAuctioneer: 'The SettlementSurplusAuctioneer contract receives the surplus from the AccountingEngine when Global Settlement is triggered and auctions it off.',
    oracleJob: 'The OracleJob contract enables keepers to be rewarded for updating the redemption rate, and the oracle price feeds.',
    accountingJob: 'The AccountingJob contract enables keepers to be rewarded for updating the system surplus and debt.',
